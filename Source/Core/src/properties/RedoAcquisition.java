...
/**
 * This class allows to verify the first property of the project (refer to the pdf included in the project): occurrence_of Enter e where e . state == 'redo '
...
public class RedoAcquisition extends GroupProcessor{
	...
	public RedoAcquisition() {
		...
		Connector.connect(m_getState, 0, m_equalRedo, 0);	//On peut pas cast unJSONeLEMENT EN string
		...
		this.addProcessors(m_fork, m_getId, m_equalId, m_constId, m_getState, m_equalRedo, m_constRedo, m_logicAnd);
